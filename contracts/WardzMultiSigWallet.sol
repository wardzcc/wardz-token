...
import "zeppelin-solidity/contracts/ownership/Multisig.sol";
import "zeppelin-solidity/contracts/ownership/Shareable.sol";
import "zeppelin-solidity/contracts/DayLimit.sol";
...
contract WardzMultiSigWallet is Multisig, Shareable, DayLimit {
   ...
   */
  function WardzMultiSigWallet(address[] _owners, uint256 _required, uint256 _daylimit) Shareable(_owners, _required) DayLimit(_daylimit) { }
  ...
  function changeOwner(address _from, address _to) onlyOwner external {
